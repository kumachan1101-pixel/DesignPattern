...
| 5. 対策案の検討 | 【方向性の特定】原因から解消方向を導く → 【手段①】最初に人が思いつくシンプルな案（残る課題を明示） → 【手段②】課題を受けた発想の転換・インターフェース案（クラス図） | `## ステップ5：対策案の検討` |
| 6. 天秤にかける | 【評価軸を先に宣言】→ 【手段①vs②の比較表】→ 【採用を決める】→ 【耐久テスト】ヒアリングリスクを実演 → 【使う/使わない判断】 | `## ステップ6：天秤にかける` |
...
人間の思考回路の順序：
`原因 → 方向性 → 手段① → 残る課題 → 手段② → クラス図＋パターン名初登場 → (Step6) 評価軸宣言 → 手段①vs②比較 → 採用決定 → 耐久テスト → 使う/使わない判断`
