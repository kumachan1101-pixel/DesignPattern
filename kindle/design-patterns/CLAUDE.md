...
| 5. 対策案の検討 | 【第0章の4分類に当てはめ → 手札候補を絞り込む】→ ケース①候補1つ：直接適用 / ケース②複数・組み合わせ：統合実装 / ケース③複数・別々に試す：手段①（残る課題）→ 手段② ＊ここで初めてパターン名登場 | `## ステップ5：対策案の検討` |

| 6. 天秤にかける | ケース③のみ：【評価軸を先に宣言】→ 【手段①vs②の比較表】→ 【採用を決める】 / 全ケース共通：→ 【耐久テスト】ヒアリングリスクを実演 → 【使う/使わない判断】 | `## ステップ6：天秤にかける` |
...
原因 → 第0章の4分類に当てはめ → 手札候補を絞り込む
  ケース①（候補1つ）：直接適用 → クラス図＋パターン名初登場
                      → (Step6) 耐久テスト → 使う/使わない判断（天秤なし）
  ケース②（複数・組み合わせ）：統合実装 → クラス図＋パターン名初登場
                               → (Step6) 耐久テスト → 使う/使わない判断（天秤なし）
  ケース③（複数・別々に試す）：手段①（手札A） → 残る課題
                               → 手段②（手札B） → クラス図＋パターン名初登場
                               → (Step6) 評価軸宣言 → 手段①vs②比較 → 採用決定
                               → 耐久テスト → 使う/使わない判断
```
