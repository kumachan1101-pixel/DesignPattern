...
この本の各章は、第1章と同じ7フェーズで進む。順序と標準見出しを崩してはいけない。

テンプレートの最新版は `templates/chapter-template.md` を参照。

|**フェーズ**|**標準セクション**|**内容（要点）**|
|---|---|---|
|🔵 1：現状把握|1-1仕様、1-2動作例、1-3現状コード、1-4クラス図、1-5変更要求|事実だけを確認し、問題や対策を先取りしない|
|🟣 2：仮説立案|2-1責任チェック、2-2変わる理由、2-3確定変更、2-4ヒアリング、2-5将来リスク|仮説と確定事項を分け、関係者の判断で裏付ける|
