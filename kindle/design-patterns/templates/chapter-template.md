...
<!--
【目的】
　案0〜案4を「現在の対応コスト」と「未来の対応コスト」の2軸で比較する。
　「今すぐ安い案」と「長期的に安い案」を可視化し、判断の材料にする。
...
【執筆ポイント】
　・「現在コスト」＝今すぐ実装するコスト（工数・複雑さ）
　・「未来コスト」＝次の変更要求が来たときの対応コスト
　・各セルに（高/中/低）または具体的な説明を入れる
-->
...
　・「納期を優先するなら案0」「長期運用を重視するなら案X」のようなトレードオフを明記する
