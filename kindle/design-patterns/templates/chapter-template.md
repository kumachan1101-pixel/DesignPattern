...
| 2：仮説立案 | フェーズ1の事実、関係者情報 | 今回確定したR-ID、将来リスク、内部契約、対象外、当面安定の前提の分類 |
...
2-4の表は全章で次の3列に統一する。分類・確率などの列や、行頭の🟣🟡🔴などのマーカーは付けない（当面安定の前提は2-5で扱う）。

| **将来リスク** | **時期の目安** | **根拠** |
|---|---|---|
| （将来変わりうる仕様・機能） | （継続的に／数ヶ月後 等の目安） | （誰との確認か・発言の出所） |
