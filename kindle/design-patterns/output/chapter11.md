...
|---|---|---|
| 売上データ、出力形式、追加オプション、実行要求 | レポート生成に必要な入力 | 動作例テーブル、変更要求 |
| レポート生成、機能追加、履歴記録 | レポートを作り、追加機能を反映し、操作を記録する加工 | 現状仕様の確認、装飾追加時の変更シミュレーション |
| レポート、装飾結果、実行履歴 | 生成後に確認できる結果 | 動作例テーブル、実行結果、変更シナリオ表 |
