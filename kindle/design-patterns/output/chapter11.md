...
| リスクID | 将来リスク | ヒアリング根拠 | 今回の扱い |
|---|---|---|---|
| F1 | HTML形式の追加 | 「将来は検討」 | TemplateRegistryの登録追加で影響箇所を確認するだけ |
| F2 | 再実行で当時のCSVを使う | 「将来は検討」 | データ取得境界への影響を確認するだけ |
| F3 | 履歴の永続化・上限管理 | 今回は受付履歴だけと確認 | 履歴所有者への影響を確認するだけ |
