...
★現状把握⇒設計⇒検証ではなく、以下のステップでカテゴリ分けしたい
★**現状把握 ⇒ 課題特定 ⇒ 原因特定 ⇒ 対策検討 ⇒ 比較・決定**
★問題なければ、他の章もこのフェーズで分けて各ステップを説明して
...
構造の発展は評価の位置づけにしたい。後続の章でも、評価の際に登場させたい。
...
★以下に具体的なデザインパターン名が登場しますが、この本で紹介しないパターンを出すでもよいですか？説明しないデザインパターンを出すなら、説明は入れてほしいし、後続の章で説明するなら、何章参照という形にしてほしい。出来れば、この本で扱うデザインパターンに限定した方が良いのでは？なぜなら、上の方の説明で、この本で説明するデザインパターンの考え方で網羅できると説明しているわけですから。
