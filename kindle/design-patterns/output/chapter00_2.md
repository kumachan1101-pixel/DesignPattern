...
最初のステップへ進む前に、フェーズ3で仕様変更を当てた後の「痛みコード」を比較元として再掲します。フェーズ1の変更前コードへ戻すのではありません。ステップ1は追加済みの要求をすべて保ったまま小さく整理し、ステップ2以降は直前ステップと比べます。これにより、設計を簡単に見せるために仕様を落としていないかを、コード上で確認できます。

ステップ2以降で1つの変化軸だけを抜粋する場合は、「直前ステップとの差」と「抜粋外で維持する仕様」を明記します。コードが短くなった理由を、仕様を削ったためだと誤解させないためです。
