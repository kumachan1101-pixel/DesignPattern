...
★先人たちが使っていた角かはわかりません。勝手な推測は書けませんので、修正して
★私の考え方が存分に伝わるような形にしてほしい。
★以下のファイルを参照して私の人格を理解してほしい
...
---
★現状把握のタイトルは、コードとクラス構成というより、しっかりと仕様を把握して、システムのどこで対応差ているか紐づけることだと思ってます。
★各フェーズで、何故このフェーズで必要かって、目的の事ですかね。そうであれば、目的をバシッと先頭で定義すればよいと思います。この章が、全体的に古い内容になっているため、全見直してください。１章以降の構成が最新になってます。
