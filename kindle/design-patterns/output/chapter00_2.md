...
flowchart TB
    ...
    O4["産物<br>混在している知識<br>漏れている依存<br>保ちたい骨格"]
...
| 4：原因分析 | 痛みを、混在している知識・責任・依存として説明する |
...
> - **「原因」**（フェーズ4で言語化）：問題が発生している構造的な理由のこと。たとえば、独立して変わる知識の混在、具体実装への過剰な依存、処理順序や生成方法の漏出（本来あるクラスに閉じているべき知識が、別のクラスへにじみ出てしまっている状態）などが原因になります。
