...
**変わる理由が異なる2つの軸が一つの場所に混在していると、一方を変えるたびに他方まで修正範囲が広がっていくと考えます。それぞれの変化が独立していないために、どちらを触っても全体が揺れてしまうからであると考えます。**
...
どの知識が誰によって変更されるかを把握しておくのは、設計判断において重要な手がかりになります。「誰の判断で変わるか」が違えば、それは別々に管理できるようにしておくべき知識かもしれないからです。
