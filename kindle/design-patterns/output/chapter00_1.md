...
| ファイル | 役割 | 内容 |
| --- | --- | --- |
| chapter00_1.md | **はじめに** | なぜパターンを覚えても使えないのか・3つの原則 |
| chapter00_2.md | **第一部の説明** | 7フェーズの思考プロセス（フェーズ1〜7）・ケーブル比喩・案0〜案4 |
| chapter01.md | **第1章** 変わるアルゴリズム ―― Strategy パターン | 増え続ける割引ルールをどう整理するか |
| chapter02.md | **第2章** 変わる処理の組み合わせ ―― Facade パターン | 振り込み処理の裏側を、呼び出す側に見せない |
| chapter03.md | **第3章** 変わる状態ごとの振る舞い ―― State パターン | 状態によって変わる振る舞いをどう整理するか |
| chapter04.md | **第4章** 変わる処理のステップ ―― Template Method パターン | 手順は同じなのに3つのクラスに書き直していないか |
| chapter05.md | **第5章** 変わる操作の種類 ―― Command パターン | 操作を取り消せるようにするにはどうするか |
| chapter06.md | **第6章** 変わる機能の組み合わせ ―― Decorator パターン | 組み合わせが増えるたびにクラスを作っていないか |
| chapter07.md | **第7章** 変わる通知先 ―― Observer パターン | 在庫が変わったとき、複数のシステムをどう連動させるか |
| chapter08.md | **第8章** 変わる生成の種類 ―― Factory Method パターン | 決済手段が増えるたびに利用側も変わっていないか |

### 第二部：応用演習

| ファイル | 役割 | 内容 |
| --- | --- | --- |
| chapter09_1.md | **第二部の説明** | 第一部との違い・複合問題の読み方 |
| chapter09_2.md | **第9章** | 複数パターンの融合：複雑な問題への適用 |
| chapter10.md | **第10章** | 依存の過多・変化の混在・生成と利用の混在 |
| chapter11.md | **第11章** | 複数の「変わる理由」が複雑に絡み合う複合課題 |
| chapter12.md | **第12章** | 状態変化・通知・判定ルールの混在 |
