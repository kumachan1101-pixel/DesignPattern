...
★以下の説明、私の意図が記載できてない。LightningだとiPhoneしか充電できないですよね？でも、TypeCなら、TypeCの対応するiPhoneなら充電できるし、タイプCの接続口を持っている機材ならすべて充電できます。つまり、汎用規格を取り入れることで、接続先を交換して使える、まさに変更しやすい作りであり、ソフトウェア設計においても部品入れ替えが可能になる、そういう話をしたかった。
