...
「誰が決めるか」が分からないとき——現場では「お客さんからの要求なんだけど、社内のどの部門が出したかは伝えられていない」というケースがあります。そういうときは、問いを一段ほぐします。

> **「もしこのルールが来年また変わるとしたら、誰があなたに連絡してきますか？」**

要求の伝言者（窓口の営業やPMなど）ではなく、「変更の引き金を引く人」を探す問いです。「このルールを変えるとき、誰の承認がなければ動けないか」でも同じ効果があります。その人（またはチーム）が、設計上の境界線を決める実質的な根拠になります。
