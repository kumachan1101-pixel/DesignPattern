...
| 章 | ファイル | 扱うパターン | 変わるもの（カプセル化の対象） | 状態 |
| --- | --- | --- | --- | --- |
| **第0章** | chapter00_1.md<br>chapter00_2.md | （基礎知識） | **3つの原則 + 9ステップの思考プロセス（S0〜S8）** | ✅ 完成 |
| **第1章** | chapter01.md | Strategy | 実行する振る舞い（アルゴリズムやルール） | ✅ 完成 |
| **第2章** | chapter02.md | Facade | 複雑な外部連携の詳細 | ✅ 完成 |
| **第3章** | chapter03.md | State | 状態とそれに伴う振る舞い | ✅ 完成 |
| **第4章** | chapter04.md | Template Method | 処理の各ステップの実装 | ✅ 完成 |
| **第5章** | chapter05.md | Command | 実行する操作そのもの（要求の発生と実行） | ✅ 完成 |
| **第6章** | chapter06.md | Decorator | 追加する機能の組み合わせ | ✅ 完成 |
| **第7章** | chapter07.md | Observer | 通知先の種類や依存方向 | ✅ 完成 |
| **第8章** | chapter08.md | Factory Method | 作るオブジェクトの種類（生成と利用） | ✅ 完成 |
| **第9章** | chapter09_1.md<br>chapter09_2.md | （応用演習①） | 複数パターンの融合：複雑な問題への適用 | 🔄 執筆中 |
| **第10章** | chapter10.md | （応用演習②） | 依存の過多・変化の混在・生成と利用の混在 | 🔄 執筆中 |
| **第11章** | chapter11.md | （応用演習③） | 複数の「変わる理由」が複雑に絡み合う複合課題 | 🔄 執筆中 |
| **第12章** | chapter12.md | （応用演習④） | 状態変化・通知・判定ルールの「変わる理由」が絡み合う複合課題 | 🔄 執筆中 |
