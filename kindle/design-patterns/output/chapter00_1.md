...
この本を読み終えたとき、あなたは次のことができるようになっています。

> **「このコードに変更が来たとき、どこを触れば済むかが、コードを読んで5分で分かる。」**

それだけです。派手な知識は一つも必要ありません。「変わる理由が混在している」と見抜く目と、「分ける」という判断ができれば、デザインパターンは自然についてきます。
...
| chapter00_2.md | **第一部の説明** | 9ステップの思考プロセス（S0〜S8）・ケーブル比喩・案0〜案4 | ✅ 完成 |
| chapter01.md | **第1章** Strategy | 実行する振る舞い（アルゴリズムやルール） | ✅ 完成 |
| chapter02.md | **第2章** Facade | 複雑な外部連携の詳細 | ✅ 完成 |
| chapter03.md | **第3章** State | 状態とそれに伴う振る舞い | ✅ 完成 |
| chapter04.md | **第4章** Template Method | 処理の各ステップの実装 | ✅ 完成 |
| chapter05.md | **第5章** Command | 実行する操作そのもの | ✅ 完成 |
| chapter06.md | **第6章** Decorator | 追加する機能の組み合わせ | ✅ 完成 |
| chapter07.md | **第7章** Observer | 通知先の種類や依存方向 | ✅ 完成 |
| chapter08.md | **第8章** Factory Method | 作るオブジェクトの種類（生成と利用） | ✅ 完成 |
...
> ここで紹介する「決定者を基準に分離する」という考え方は、原則1の説明に登場しますが、本書のすべての設計判断の根底にある考え方です。各章のステップ0〜2でも、この問いに戻ってきます。
