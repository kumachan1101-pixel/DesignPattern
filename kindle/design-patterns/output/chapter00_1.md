...
| --- | --- | --- | --- | --- |
| **第0章** | chapter00_1.md<br>chapter00_2.md | （基礎知識） | **3つの哲学 + 8ステップの思考プロセス** | ✅ 完成 |
...
> ここで紹介する「決定者を基準に分離する」という考え方は、哲学1の説明に登場しますが、本書のすべての設計判断の根底にある考え方です。各章のステップ0〜2でも、この問いに戻ってきます。
