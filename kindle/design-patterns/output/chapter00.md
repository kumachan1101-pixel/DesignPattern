...
★以下の「変わるもの」と「変わらないもの」を分離するは、以降の説明で登場しますか？変わる理由が複数の決定者かどうか、しか論点がなさそうです。ただ、デザインパターンの各章の説明を見ると、変わるものと、変わらないものが、本質があり、分離しているように見えます。この２点、明確に使い分けした方が良いのではないですか。
