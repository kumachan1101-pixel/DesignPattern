...
コードを読む前に、読む「目的」を定義しておかないと、ただコードを追うだけになります。
設計を読む目的は「動きを把握する」ことではありません。
「変わる理由がどこに混在しているか」を発見することです。

この違いが、最初から問いを持って読むか、後から問題に気づくかの差を生みます。

**このステップでやること**

まず、この章で扱うシステムのシナリオを共有します。
どんなクラスが登場し、誰が何を担当しているか——コードを読む前の地図として整理します。

次に、そのシナリオを聞いた段階で「仮説」を立てます。

> 「このシステムの中で、何が変わりやすく、何は変わらないか？」

コードを読まなくても、ビジネスの性質から「変わりやすそうな部分」はある程度想像できます。
外部の都合で変わるもの、法律・規制で変わるもの、そして「会社がある限り変わらない」もの。
この仮説をステップ2でコードと照合することで、推測ではなく根拠のある判断になります。

最後に、この章全体を通じて使う「設計のレンズ（問い）」をセットします。

> 「このコードの中に、**『変わる理由』が異なる2つのものが、同じ場所に混在していないか？」**

**3つの哲学との接続**

これは**哲学1**「変わるものをカプセル化せよ」の問いを、コードを読む前に意識にセットするステップです。
問いを持って読むか、持たずに読むかで、同じコードから得られる気づきがまるで変わります。
...
### ステップ2：変動と不変の峻別 ―― 仮説を関係者ヒアリングで確定する

**なぜこのステップが必要か**

ステップ0で立てた仮説は、あくまで推測です。
「これは変わりやすそうだ」という感覚は、ビジネスの実態と一致しているとは限りません。
...
| ステップ | 中心の問い | 主な哲学との接続 |
|---|---|---|
| ステップ0 | 何が変わりやすそうか（仮説） | 哲学1への準備 |
| ステップ1 | 各クラスの責任は1つか | 哲学1（責任の単一性） |
| ステップ2 | 変わるものと変わらないものを根拠を持って分ける | 哲学1（変化の特定） |
