...
8ステップの**ステップ3〜4**で「何と何が混在しているか・なぜ痛いか」が分かります。そして**ステップ5**で「ではどうやって分離するか」を検討します。

このセクションは、ステップ5で使う「分離の選択肢」を事前に一覧にしたものです。各章を読み進める中で「ステップ5でこの手法を使っているのか」と照らし合わせながら参照してください。
