...
カフェのドリンクシステムでは、「基本ドリンク」と「トッピング」を分けて管理するのが一般的です。基本ドリンクは注文の土台（ベース価格）として固定されており、トッピングはあとから積み上げて合計価格に加算されます。これは「ベース価格 ＋ オプション料金の加算」という、飲食業界でよく見られる料金体系です。
...
価格は商品企画部が管理します。原材料費や販売戦略に応じて変更が生じるため、開発チームではなく商品企画部が「何がいくらか」を決定します。これは現実の業務システムでも一般的な責任分担です。
