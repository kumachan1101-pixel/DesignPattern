...
佐藤マネージャーとの対話から浮かび上がった、確定変更ではないが今後変わりうるリスクをまとめます。全章と同じく、将来リスクには🟣を付け、確定変更と混在させません。
★他の章と以下表の書き方が異なる理由は何ですか。他の章と照らしてほしい。テンプレが間違っているのか。なぜ、OKと判断されているのか。テンプレのチェックの粒度が荒いのか
