...
★以下は1-3のクラス構成図の前に持ってきた方が良いのでは？他章も見直して
**このシステムの登場クラス**
...
| Regular | ✓          | ✓      | 9,000円（10%引き）→ **8,550円（重ね掛け：5%引き×10%引き）**　★ここの計算意味わからない。 |
...
★チームの話は記載しないようにしたのでは？適切かどうかは判断できるのか
★０章の考え方の流れになっているか。変わりそうなところを予測して、そこをヒアリングするのですよね？
