...
**得られること2**（変更の痛みの発生源の判断）：フェーズ3〜4で、割引条件と注文計算の骨格が同じメソッドに混在し、割引担当の変更が骨格へ波及していることを接続点から確認しました。

**得られること3**（接続点を小さくする効果）：フェーズ6と7で、接続点を「金額を受け取り、金額を返す」という契約へ絞ることで、計算フローと割引ルールを別々に変更しやすくなることを学びました。
