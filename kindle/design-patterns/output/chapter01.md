...
★以下の「分ける」を強調しているが、ソフトウェア設計の例でいうと、Chapter00に登場した、分離する、隠ぺいするなどが該当するでしょうか。言葉の接続はしてほしい。例えば、Chapter00でレゴブロックの操作と、ソフトウェア設計の変更について、紐づけた表を用意するとか。そうすれば、以下の説明が分かりやすくなると思います。他の章にも同様に修正してほしい。
...
★Chapter02の「章のまとめ」は、体験談など踏まえた、困りごとに対してどういう考え方で対応すればよいかのまとめになっており、とても、心に響きます。上記の整理した結果はもちろんあった方が良いですが、もっと、心が入った文面で追加してもらった方が良いと思います。他の章にも同様に修正してほしい。