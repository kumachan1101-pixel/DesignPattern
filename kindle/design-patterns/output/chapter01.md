...
| 機能ID | 現行機能 | 対応する要求ID |
|---|---|---|
| 機能ID1 | 顧客IDから会員情報を取得する | 要求ID4 |
| 機能ID2 | 会員条件に応じて割引と支払金額を計算する | 要求ID1、要求ID2、要求ID3 |
| 機能ID3 | 購入結果を利用者へ提示する | 要求ID5 |
...
|---|---|---|---|
| 機能ID1 | 継続<br/>根拠: — | 顧客IDから会員情報を取得する | 要求ID4 |
| 機能ID2 | 変更<br/>根拠: 変更ID1、変更ID2 | 既存会員割引を守り、サマーセールを逐次適用して支払金額を計算する | 要求ID1、要求ID2、要求ID3、要求ID6 |
| 機能ID3 | 変更<br/>根拠: 変更ID1、変更ID2 | 適用した全割引と最終支払金額を提示する | 要求ID5 |
...
|---|---|---|---|
| 機能ID1 | 継続 | 要求ID4 | 登録・未登録顧客の既存動作を回帰確認<br/>**判定:** 合格 |
| 機能ID2 | 変更 | 要求ID1、要求ID2、要求ID3、要求ID6 | 既存小計・Premium・キャンペーンを回帰し、セール単独と逐次割引を受入確認<br/>**判定:** 合格 |
| 機能ID3 | 変更 | 要求ID5 | 既存項目を残して全割引と最終金額を表示<br/>**判定:** 合格 |
