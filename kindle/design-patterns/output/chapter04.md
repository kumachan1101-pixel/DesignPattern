...
変更後の仕様を、1-1と同じ粒度で、正常系の入力・判定・加工・出力として確認します。1-1の図との差分は、フォーマット種別に「EC店」が加わること、共通手順の直後に全形式共通の「形式バージョンを確認」という加工が挟まること、EC店だけ解析の後に「ポイント付与・会員ランク割引の計算」という加工が加わることの3点です。
