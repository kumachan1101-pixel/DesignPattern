...
classDiagram
    ...
    class ManualImportController {
        -manager ImporterManager
        +handleUpload(filePath) void
    }
    class ImporterManager {
        +execute(filePath) bool
    }
    class StoreDataImporter {
        +import(filePath) bool
    }
    class ECDataImporter {
        +import(filePath) bool
    }
    ...
    BatchImportJob --> ImporterManager : 具体×間接
    ManualImportController --> ImporterManager : 具体×間接
    ImporterManager --> StoreDataImporter : 具体×直接
    ImporterManager --> ECDataImporter : 具体×直接
    ImporterManager --> FCDataImporter : 具体×直接
```
