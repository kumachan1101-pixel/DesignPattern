...
## ステップ0：仮説を立てる ―― コードを読む前に「変わりそうな場所」を予測する

> **入力：** システムのシナリオ説明（言葉だけ。コードはまだ読まない）
> **産物：** 変動と不変の「仮説テーブル」
...
この仮説をステップ2（2.4）でコードと照合します。

---

## ステップ1：コードを読む ―― 各クラスの責任を確認し、責任外の関心を探す

> **入力：** ステップ0の仮説を持ちながら、実際のコードを読む
> **産物：** 責任チェック表。責任外の知識が混在している箇所の発見。
...
### 2.2 責任チェック：MonthlyBatchは自分の責任だけを持っているか
