...
動いています。しかし、このコードには設計上の大きな問題が潜んでいます。

---

ここで、この章を通して使う「設計の問い（レンズ）」をセットアップしましょう。
...
では、先ほどセットアップした問いを今のシステムに当てはめて、**責任チェック**に入ります。

### MonthlyBatchは自分の責任だけを持っているか
