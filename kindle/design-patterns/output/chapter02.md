...
|---|---|---|
| 送金元口座、振込先口座、送金金額、認証情報 | 振り込みに必要な入力 | 動作例テーブル、変更要求 |
| 口座確認、残高確認、OTP認証、送金実行、履歴記録 | 振り込みを成立させる手順 | 現状仕様の確認、変更シミュレーション、原因分析 |
| 振り込み完了、エラー、履歴 | 利用者とシステムに残る結果 | 動作例テーブル、実行結果、変更シナリオ表 |
