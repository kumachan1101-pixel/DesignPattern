...
コードを読む前に、現状のワークフローがどんな入力に対してどんな出力を返すかを確認します。ここでは、申請中と承認済みという現在扱っている状態、承認者、申請金額だけを扱います。

| 入力 | 承認者 | 結果 |
| --- | --- | --- |
| 申請中 / 50,000円 | 登録済みの部長 | 承認待ち状態へ移行 / 申請者に通知 |
| 承認済み / 50,000円 | 登録済みの部長 | 承認完了状態へ移行 / 関係者に通知 |
| 申請中 / 50,000円 | 未登録の承認者 | 承認者IDが存在しないエラー |
| 申請中 / 200,000円 | 上限100,000円の承認者 | 承認上限を超えるエラー |
