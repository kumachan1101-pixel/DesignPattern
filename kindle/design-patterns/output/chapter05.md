...
**【1】 データとインフラ（Category / CategoryDatabase / LedgerRepository / BalanceViewRenderer）**
...
**【2】 実行先クラス（ExpenseManager / IncomeManager）**
...
**【4】 具体的な操作クラス（AddExpenseAction / AddIncomeAction）**
...
**【5】 操作履歴を保持しUndo/Redoを制御する仲介役クラス**
...
同じ `main()` の中で、次に直前の2操作をUndoし、支出をRedoします。
