...
5. 現行／変更後機能ID、要求ID、変更ID、課題ID、リスクIDの台帳と用途が混同されず、機能・要求と課題が別系統か確認する。
6. フェーズ2が見当→確認質問→ヒアリング回答、フェーズ5が原因→候補→全体評価→課題ID確定、フェーズ6が設計理由→部分クラス図→コードの順になっているか確認する。
...
- 全有効機能IDの回帰結果、要求IDの受入エビデンス、課題IDの構造結果、変更IDの変更影響が分離して追跡されている。
