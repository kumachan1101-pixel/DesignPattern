...
6. フェーズ2が見当→確認質問→ヒアリング回答、フェーズ5が原因→候補→全体評価→課題ID確定、フェーズ6が構想→要点コード→採用判断の順になっているか確認する。フェーズ6の責任・継承・保持・注入の判断には、対象外を明記した部分クラス図と対応コードを置き、それらを統合した完成クラス図はフェーズ7だけに置く。
