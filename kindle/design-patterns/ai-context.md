...
| 依頼文（例） | 生成範囲 |
|:---|:---|
| `フェーズ1を書いて` | 1-1〜1-8 全体 |
| `フェーズ1の1-1〜1-4を書いて` | 指定サブ項目のみ |
| `フェーズ2を書いて` | 2-1〜2-4 全体 |
| `フェーズ3を書いて` | 3-1〜3-3 全体 |
| `フェーズ4を書いて` | 4-1〜4-3 全体 |
| `フェーズ5を書いて` | 5-1〜5-4 全体 |
| `フェーズ6の6-1〜6-6を書いて` | 2×2マトリクス＋案0〜案4 |
| `フェーズ6の6-7〜6-10を書いて` | 評価軸・コスト天秤・採用・耐久テスト |
| `フェーズ7を書いて` | 最終コード・変更影響グラフ・変更シナリオ表 |
| `整理・振り返り・パターン解説を書いて` | 後段すべて |
| `[セクション名]を修正して：[具体的な指示]` | 部分修正 |
