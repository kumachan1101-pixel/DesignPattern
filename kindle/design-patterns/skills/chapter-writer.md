...
- `rules/step5-6-model.md`（S5〜S8の詳細モデル）
...
S4で「分ける」と判断した場所に接続点を特定し、以下の4視点で課題を定義する（詳細は `rules/step5-6-model.md` 参照）：
...
この節の核心：S5の課題定義に対する正当な応答として案を提示する（詳細は `rules/step5-6-model.md` 参照）。
